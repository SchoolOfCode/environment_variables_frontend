        ...
        <div>
          <div className="flex flex-col md:flex-row items-center justify-center md:space-x-[3em] space-y-[2rem] mt-[2rem] mb-[2rem] md:space-y-[0]">
            ...
            <div className="flex items-center justify-center text-[#FF9505] text-[18px] text-center font-medium">
              <p>If you would like to join a clean-up in your area, click <strong>"Join A Clean"</strong>, and sign up by joining an existing clean on the map. Start a clean-up in your area by clicking the <strong>"Start A Clean"</strong> button. If you have hosted an event, make sure to log the results of your hard work via the <strong>"Log A Clean"</strong> button to update the project with how many bags were collected and how many people took part.</p>
            </div>
