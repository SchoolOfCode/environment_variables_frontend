...
const WeatherForecast = ({ weatherObject }) => {
  ...
  return (
    //main div container
    <div className="flex-col justify-start mb-4 mt-4 ml-4 w-3/5">
      
      {/* todays weather stats */}
      <div className="flex justify-evenly bg-stone-300 p-4 ">
        <div>
      ...
      <div className="flex justify-evenly bg-amber-500 ">
        <div className="flex-col border rounded mt-4 mb-4 w-48 p-4 ml-4 flex justify-evenly items-center text-xl font-bold mb-4">
          <p>{weatherObject?.list[8].dt_txt.slice(0, 10)}</p>
          <p className="text-3xl"> {Math.floor(weatherObject?.list[8].main.temp)}°C</p>
          <img
        ...
        <div className="flex-col border rounded mt-4 mb-4 w-48 p-4 ml-4 flex justify-evenly items-center text-xl font-bold mb-4">
          ...
          <p className="text-3xl"> {Math.floor(weatherObject?.list[16].main.temp)}°C</p>
          <img 
        ...
        <div className="flex-col border rounded mt-4 mb-4 w-48 p-4 ml-4 flex justify-evenly items-center text-xl font-bold mb-4">
          ...
          <p className="text-3xl"> {Math.floor(weatherObject?.list[24].main.temp)}°C</p>
          <img
        ...
        <div className="flex-col border rounded mt-4 mb-4 w-48 p-4 ml-4 mr-4 flex justify-evenly items-center text-xl font-bold mb-4">
          <p>{weatherObject?.list[32].dt_txt.slice(0, 10)}</p>
          <p className="text-3xl"> {Math.floor(weatherObject?.list[32].main.temp)}°C</p>
          <img
