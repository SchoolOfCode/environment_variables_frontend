...
const OurMission = () => {
  return (
    <div className={Style.missionContainer}>
        ...
        <img className={Style.imageCSS} src="https://www.countrywidegrounds.com/wp-content/uploads/jch-optimize/ng/wp-content_uploads_2020_02_Litter-picking-and-fly-tipping-300x200.webp"/>
    </div>
  )
}
